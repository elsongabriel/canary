...
GameStore.Categories = {
	...
	-- Tournament
	{
		...
		rookgaard = true,
		subclasses = { "TS-Exercise Weapons", "TS-Outfits", "TS-Mounts", "TS-Dolls", "TS-House Furniture" },
	},
	-- Tournament ~ Tickets
	--{
		...
		offers = {
			{
				...
				itemtype = 28552,
				charges = 1500,
				description = "<i>Use it to train your sword fighting skill on an exercise dummy!</i>\n\n{character}\n{storeinbox}\n{info} use it on an exercise dummy to train your sword fighting skill\n{info} usable 1500 times a piece\n{info} this item cannot be traded and cannot be moved",
				type = GameStore.OfferTypes.OFFER_TYPE_CHARGES,
